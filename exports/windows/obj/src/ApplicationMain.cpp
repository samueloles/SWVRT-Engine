...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("SWVRT-Engine",db,f2,ea,8b),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("127",36,5a,25,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("Raquel Inc.",f6,0b,fd,97));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("SWVRT-Engine",db,f2,ea,8b));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("SWVRT Engine",0e,eb,53,6f));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.raquel.swvrt",ed,53,4d,78));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("SWVRT Engine",0e,eb,53,6f))
