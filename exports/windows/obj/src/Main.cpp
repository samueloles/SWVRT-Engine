...
HXLINE(  13)		 ::flixel::FlxGame game =  ::flixel::FlxGame_obj::__alloc( HX_CTX ,1280,720,::flixel::util::typeLimit::_NextState::InitialState_Impl__obj::fromType(::hx::ClassOf< ::states::menu::TitleState >()),null(),null(),null(),null());
HXLINE(  14)		this->addChild(game);
            	}
