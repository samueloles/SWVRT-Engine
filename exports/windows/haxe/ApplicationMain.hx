...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("SWVRT-Engine", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("SWVRT-Engine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "127";
		app.meta["company"] = "Raquel Inc.";
		app.meta["file"] = "SWVRT-Engine";
		app.meta["name"] = "SWVRT Engine";
		app.meta["packageName"] = "com.raquel.swvrt";
