...
@:keep @:dox(hide) class ManifestResources {
	...
	public static function init (config:Dynamic):Void {
		...
		openfl.text.Font.registerFont (__ASSET__OPENFL__assets_fonts_unown_ttf);
		openfl.text.Font.registerFont (__ASSET__OPENFL__assets_fonts_unown_ttf1);
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_charater_boyfriend_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_charts_test_song_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_escenas_nosexd_hx extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_fonts_unown_ttf extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_imagen_charater_boyfriend_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_imagen_charater_boyfriend_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_imagen_menu_cursor_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_imagen_menu_custom_captura_de_pantalla_2025_06_28_002623_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_imagen_menu_mainbg_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_imagen_menu_note_assets_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_imagen_menu_note_assets_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_imagen_menu_titlebg_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_music_menumusic_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_scripts_1_hx extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_test_song_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_sounds_confirm_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_imagen_menu_custom_captura_de_pantalla_2026 extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_sounds_confirm_ogg1 extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_music_menumusic_ogg1 extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_fonts_unown_ttf1 extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_escenas_nosexd_hx1 extends null { }
...
@:keep @:noCompletion #if display private #end class __ASSET__assets_fonts_unown_ttf extends lime.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/fonts/Unown.ttf"; name = "Unown"; super (); }}
@:keep @:noCompletion #if display private #end class __ASSET__assets_fonts_unown_ttf1 extends lime.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/fonts/Unown.ttf"; name = "Unown"; super (); }}
...
@:keep @:expose('__ASSET__assets_fonts_unown_ttf') @:noCompletion #if display private #end class __ASSET__assets_fonts_unown_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "assets/fonts/Unown.ttf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "Unown"; super (); }}
@:keep @:expose('__ASSET__assets_fonts_unown_ttf1') @:noCompletion #if display private #end class __ASSET__assets_fonts_unown_ttf1 extends lime.text.Font { public function new () { #if !html5 __fontPath = "assets/fonts/Unown.ttf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "Unown"; super (); }}
...
@:keep @:expose('__ASSET__OPENFL__assets_fonts_unown_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_unown_ttf extends openfl.text.Font { public function new () { name = "Unown"; super (); }}
@:keep @:expose('__ASSET__OPENFL__assets_fonts_unown_ttf1') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_unown_ttf1 extends openfl.text.Font { public function new () { name = "Unown"; super (); }}

#else
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_nokiafc22_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_nokiafc22_ttf ()); super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_monsterrat_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_monsterrat_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_monsterrat_ttf ()); super (); }}
@:keep @:expose('__ASSET__OPENFL__assets_fonts_unown_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_unown_ttf extends openfl.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/fonts/Unown.ttf"; name = "Unown"; super (); }}
@:keep @:expose('__ASSET__OPENFL__assets_fonts_unown_ttf1') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_unown_ttf1 extends openfl.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/fonts/Unown.ttf"; name = "Unown"; super (); }}
